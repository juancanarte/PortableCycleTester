...
class ct_read_cafe_1(AsyncWebsocketConsumer):
    ...
    async def send_sensor_data(self):
        ...
        while self.running:
            if not self.paused:
                _pos, _setPos, _signalType, _relay_O, _relay_C, _relayCountA, _relayCountB, _relayCountFA, _relayCountFB, _hor, _min, _sec  = funciones_cycleTest.cycleTest_read_cafe_1()
